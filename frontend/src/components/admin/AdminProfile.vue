<template>
  <!--breadcrumb-->
  <page-titles>
    <template #title> Admin Profile </template>
    <template #desc> Admin Profile </template>
  </page-titles>
  <!--end breadcrumb-->
  <div class="container">
    <div class="main-body">
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-column align-items-center text-center">
                <img
                  src="../../../public/assets/images/avatars/avatar-1.png"
                  alt="Admin"
...
export default {
  ...
  methods: {
    ...
    updateProfile() {
      this.form.get("http://127.0.0.1:8000/api/profile").then((res) => {
        console.log(res);
      });
    },
  },
