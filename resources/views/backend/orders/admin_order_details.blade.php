                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table" style="background:#F4F6FA;font-weight: 600;">
                            ...
                            <tr>
                                <th>Order Amonut:</th>
                                <th>{{ number_format($order->amount, 0) }} IQD</th>
                            </tr>
                            ...
                            <tr>
                                ...
                                @if ($order->status == 'pending')
                                    <th><a href="{{ route('pending-confirm', $order->id) }}"
                                            class="btn btn-block btn-success" id="confirm">Confirm
                                            Order</a>
                                    @elseif($order->status == 'confirm')
                                    <th><a href="{{ route('confirm-processing', $order->id) }}"
                                            class="btn btn-block btn-success" id="processing">Processing Order</a>
                                    @elseif ($order->status == 'processing')
                                    <th><a href="{{ route('processing-delivered', $order->id) }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($orderItem as $item)
                                    <tr>
                                        ...
                                        <td class="col-md-3">
                                            <label>{{ number_format($item->price, 0) }} IQD <br> Total =
                                                {{ number_format($item->price * $item->qty, 0) }} IQD </label>
                                        </td>
