                                        ...
                                        <div class="product-card-bottom">
                                            ...
                                            @if ($item->discount_price == null)
                                                <div class="product-price">
                                                    <span>{{ $item->selling_price }} IQD</span>
                            ...
                            <article class="row align-items-center hover-up">
                                ...
                                <div class="col-md-8 mb-0">
                                    ...
                                    @if ($hot_deal->discount_price == null)
                                        <div class="product-price">
                                            <span>{{ $hot_deal->selling_price }} IQD</span>

                                        </div>
                                    @else
                                        <div class="product-price">
                                            <span>{{ $hot_deal->discount_price }} IQD</span>
                                            <span class="old-price">{{ $hot_deal->selling_price }} IQD</span>
                                        </div>
                                    @endif
                                </div>
                            </article>
                            ...
                            <article class="row align-items-center hover-up">
                                ...
                                <div class="col-md-8 mb-0">
                                    ...
                                    @endphp @if ($special_offer->discount_price == null)
                                        <div class="product-price">
                                            <span>{{ $special_offer->selling_price }} IQD</span>

                                        </div>
                                    @else
                                        <div class="product-price">
                                            <span>{{ $special_offer->discount_price }} IQD</span>
                                            <span class="old-price">{{ $special_offer->selling_price }} IQD</span>
                                        </div>
                                    @endif
                                </div>
                            </article>
                            ...
                            <article class="row align-items-center hover-up">
                                ...
                                <div class="col-md-8 mb-0">
                                    ...
                                    @if ($new->discount_price == null)
                                        <div class="product-price">
                                            <span>{{ $new->selling_price }} IQD</span>

                                        </div>
                                    @else
                                        <div class="product-price">
                                            <span>{{ $new->discount_price }} IQD</span>
                                            <span class="old-price">{{ $new->selling_price }} IQD</span>
                                        </div>
                                    @endif
                                </div>
                            </article>
                            ...
                            <article class="row align-items-center hover-up">
                                ...
                                <div class="col-md-8 mb-0">
                                    ...
                                    @if ($special_deal->discount_price == null)
                                        <div class="product-price">
                                            <span>{{ $special_deal->selling_price }} IQD</span>

                                        </div>
                                    @else
                                        <div class="product-price">
                                            <span>{{ $special_deal->discount_price }} IQD</span>
                                            <span class="old-price">{{ $special_deal->selling_price }} IQD</span>
                                        </div>
                                    @endif
                                </div>
                            </article>
