                ...
                <form method="post" action="{{ route('shop.filter') }}">
                    ...
                    <div class="price-filter">
                        <div class="price-filter-inner">
                            ...
                            <div id="slider-range" class="price-filter-range" data-min="0" data-max="99999999">
                            </div>
                            <input type="hidden" id="price_range" name="price_range" value="">
                            <input type="text" id="amount" value="0IQD - 99999999IQD" style="border:none;"
                                readonly="">
        ...
        if ($('#slider-range').length > 0) {
            ...
            $("#slider-range").slider({
                ...
                slide: function(event, ui) {
                    ...
                    $("#amount").val(ui.values[0] + "-" + ui.values[1] + "IQD");
                    $("#price_range").val(ui.values[0] + "-" + ui.values[1] + "IQD");
                }
            });
        }
    })
