...
@section('vendor')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Vendor Add New Product</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Vendor Add New Product</li>
                </ol>
            </nav>
        </div>
    </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    ...
                                                    <label class="from-check-label" for="flexCheckDefault">Hot
                                                        Deals</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="special_offer" type="checkbox"
                                                        value="1" id="flexCheckDefault">
                                                    <label class="from-check-label" for="flexCheckDefault">Special
                                                        Offer</label>
