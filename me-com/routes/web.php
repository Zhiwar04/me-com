...
'middleware' => [ 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath' ]], function()
{
    ...
    // socialite route login start
    Route::get('/auth/facebook/redirect',[SocialiteController::class, 'facebookRedirect'])->name('facebook.login');
    Route::get('/auth/facebook/callback',[SocialiteController::class,'facebookCallback'] )->name('facebook.callback');
    Route::get('/auth/{provider}/redirect',[SocialiteController::class, 'redirect'])->name('socialite.login');

    Route::get('/auth/{provider}/callback',[SocialiteController::class,'callback'] )->name('socialite.callback');


    // socialite route login end
                    //       routes             //
                   //routes for frontend
