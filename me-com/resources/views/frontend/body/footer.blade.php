            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        ...
                        {{-- <img src="{{ asset('frontend/assets/imgs/theme/bg/ne.jpg') }}" alt="newsletter" /> --}}
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="logo mb-30">
                            <a href="index.html" class="mb-15"><img src="{{ asset($setting->logo) }}"
                                    alt="logo" /></a>
                            <p class="font-lg text-heading">Awesome website Ecommerce</p>
                        </div>
...
>>>>>>> 249815441ff485981a36256d2e195cd30e9dfcaf
            ...
            <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                ...
                <div class="hotline d-lg-inline-flex">
                    ...
                    <p style="font-size: 18px;">{{ $setting->support_phone }}<span>24/7 Support Center</span></p>
                </div>
            </div>
