                        ...
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <div class="clearfix product-price-cover">
                                ...
                                @if ($product->discount_price == null)
                                    <div class="product-price primary-color float-left">
                                        <span id="dprice"
                                            class="current-price text-brand">{{ number_format($product->selling_price, 0) }}
                                            IQD</span>
                                ...
                                @else
                                    <div class="product-price primary-color float-left">
                                        <span id="dold_price"
                                            class="current-price text-brand">{{ number_format($product->discount_price, 0) }}
                                            IQD</span>
                                        <span>
                                            <span class="save-price font-md color3 ml-15">{{ round($discount) }}%
                                                Off</span>
                                            <span
                                                class="old-price font-md ml-15">{{ number_format($product->selling_price, 0) }}
                                                IQD</span>
                                        </span>
                                    </div>
                                @endif
                            ...
                            <div class="detail-extralink mb-50">
                                <div class="detail-qty border radius">
                                    ...
                                    <input type="number" name="quantity" id="dquantity" class="qty-val" value="1"
                                        min="1" max="{{ $product->product_qty }}">

                                </div>
                                <div class="product-extra-link2">
                                    {{-- ajax sending data in here --}}
                                    <input type="hidden" name="" id="id" value="{{ $product->id }}">
                                    <input type="hidden" id="vproduct_id" value="{{ $product->vendor_id }}">
                                    <button type="submit" onclick="addInDetails()" class="button button-add-to-cart"><i
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                <div class="vendor-logo d-flex mb-30">
                                    <img src="{{ !empty($product->vendor->photo)
                                        ? url('upload/vendor_images/' . $product->vendor->photo)
                                                    ...
                                                    @else
                                                        <div
                                                            ...
                                                            <div class="user justify-content-between d-flex">
                                                                ...
                                                                <a href="#"
                                                                    class="font-heading text-brand text-black mt-2 font-bold uppercase">{{ $item->user->name }}</a>
                                                                <div class="desc">
                                                                    <div class="d-flex justify-content-between mb-10">
                                                                        <div class="d-flex align-items-center">
                                                                            <span
                                                                                class="font-xs text-muted mx-5">{{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span>
                                                                        </div>
                                                                        <div class="product-rate d-inline-block">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            @else
                                                <div class="product-price">
                                                    ...
                                                    <span
                                                        class="old-price">{{ number_format($product->selling_price, 0) }}
                                                        IQD</span>
                                                </div>
                                            @endif
