                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary">https://kurdishMultivendorE-Commrance.com</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        ...
                                        <span class="text-secondary">zhiwar02</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary">zhiwar03</span>
                                    </li>
                                    <li
                                        ...
                                        <span class="text-secondary">zhiwar osman</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('vendor.profile.store') }}" method="post"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <select name="vendor_join" class="form-select mb-3"
                                                ...
                                                <option value="2023"
                                                    {{ $vendor->vendor_join == 2023 ? 'selected' : '' }}>
                                                    2023
                                                </option>
                                                <option value="2024"{{ $vendor->vendor_join == 2024 ? 'selected' : '' }}>
                                                    2024</option>
                                                <option
                                                    value="2025"{{ $vendor->vendor_join == 2025 ? 'selected' : '' }}>
                                                    2025</option>
                                                <option
                                                    value="2026"{{ $vendor->vendor_join == 2026 ? 'selected' : '' }}>
                                                    2026</option>
                                                <option
                                                    value="2027"{{ $vendor->vendor_join == 2027 ? 'selected' : '' }}>
                                                    2027</option>
                                                <option
                                                    value="2028"{{ $vendor->vendor_join == 2028 ? 'selected' : '' }}>
                                                    2028</option>
                                                <option
                                                    value="2029"{{ $vendor->vendor_join == 2029 ? 'selected' : '' }}>
                                                    2029</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="vendor_short_info" class="form-control" id="inputAddress2" placeholder="information "
                                                rows="3">{{ $vendor->vendor_short_info }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
